...
// import WalletConnectProvider, { EthereumProviderOptions } from '@walletconnect/ethereum-provider'

// TODO: @walletconnect/ethereum-provider does not seem to support es5 cjs output

// const __DEV__ = false
// export const URI_AVAILABLE = 'URI_AVAILABLE'

// export type WalletConnectConnectorArguments = EthereumProviderOptions
...
// function getSupportedChains({ chains }: WalletConnectConnectorArguments): number[] | undefined {
//   return chains
// }
...
//       // await this.walletConnectProvider.session(
//       //   this.config.chainId ? { chainId: this.config.chainId } : undefined
//       // )
//       // this.emit(URI_AVAILABLE, this.walletConnectProvider.session.ur)
//     }
